...
train_dataset = dataset(split='test', **kwargs)
...
with torch.no_grad():
    ...
    for batch in train_data_loader:
        ...
        target_path='/home/jcn/桌面/Nerf/nerf_my/checkpoints_nert_1/val'
        name=path.split('_')[-1]
        np.save(os.path.join(target_path,f'surface_{name}.npy'),surface_points)
