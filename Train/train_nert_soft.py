...
for epoch in range(100):
    ...
    for batch in train_data_loader:
        ...
        loss = rgb_loss + vis_loss_outside +vis_loss_inside +0.1*regular_loss
        ...
        o_shared.zero_grad()
        loss.backward()
        # print('p_PRT', p_PRT.requires_grad)
        # print('p_PRT', p_PRT.grad)
        o_shared.step()
        ...
        logger.add_scalar('train/regular_loss', 0.1*regular_loss, it)
